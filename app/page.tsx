        ...
        <div className="container py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative">
            <div className="aspect-[4/3] w-full rounded-2xl overflow-hidden shadow-lg border border-neutral-200">
              <img src="https://images.unsplash.com/photo-1617191518004-1d5a2ebfa75f?q=80&w=1200&auto=format&fit=crop" alt="Milanesa torta" className="h-full w-full object-cover" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            <div className="mt-3 space-y-1 text-neutral-700">
              ...
              <p><strong>Email:</strong> info@josestorta.com</p>
            </div>
